...
class _CartCouponState extends State<CartCoupon> with Utility, CartMixin, SnackMixin, GeneralMixin {
        ...
        ...List.generate(cartData.coupons.length, (index) {
          ...
          return Row(
            ...
            children: [
              ...
              Text(convertCurrency(context, unit: unit, currency: currencyCode, price: coupon),
